class Macarrao {
    ...
    constructor(tipo: string, preparo: number) {
        this.tipo = tipo;
    ...
    public cozinhar() : any {
        this.prepTime ++
        if(this.prepTime < this.preparo) {
            return console.log("cozinhando")
        }
        if(this.preparo == this.prepTime) {
...
class Chines extends Macarrao {
    ...
    constructor(molho: string, tipo: string, preparo: number) {
    super(tipo, preparo)
    this.molho = molho
    }
...
class Yakissoba extends Chines {
    ...
    yakissoba : string
    alergico : boolean
    constructor(sabor: string, molho : string, tipo : string, preparo : number) {
    ...
    public comer()  {
       ...
       return console.log("garganta inflamada demais para comer")
        ...
        else if (this.prepTime > this.preparo) {
